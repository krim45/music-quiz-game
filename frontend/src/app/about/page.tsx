...
const faq = [
  ...
  },
  {
    ...
    a: '기본적으로 노래 제목의 정확한 표기를 권장하지만, 원활한 플레이를 위해 띄어쓰기(공백), 대소문자, 특수문자는 구분하지 않고 정답으로 인정합니다. 제목 뒤에 붙은 괄호 부분(예: "미쳐 (Crazy)"의 "(Crazy)")은 빼고 입력해도 됩니다. 다만, 오타가 있으면 오답으로 처리될 수 있습니다. 영어 제목의 경우 한국어 발음 표기나 공식 한국어 제목도 데이터베이스에 등록되어 있다면 정답으로 인정됩니다.',
  },
  {
